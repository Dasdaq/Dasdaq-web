...
- [支持的语言特性 和 Polyfills](#supported-language-features-and-polyfills)
- [在编辑器显示语法高亮](#syntax-highlighting-in-the-editor)
- [在编辑器显示 Lint Output](#displaying-lint-output-in-the-editor)
- [在编辑器 Debugging](#debugging-in-the-editor)
...
- [使用 `public` 文件夹](#using-the-public-folder)
  - [Changing the HTML](#changing-the-html)
  - [Adding Assets Outside of the Module System](#adding-assets-outside-of-the-module-system)
  - [什么时候该碰 `public` 文件夹](#when-to-use-the-public-folder)
...
1. ‍😄 👮  Linter is your best friend! 持续集成将会把 ESlint 的 Warning 视为 Error，请确保每次提交前你的 Linter 没有 Warning 和 Error。
...
Use `react-script-rewired` and its tools instead of eject, thank you
